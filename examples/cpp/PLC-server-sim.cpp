...
#include "snap7.h"
	...
	unsigned char DB38[1280];  // Our DB2
	unsigned char DB102[1280];  // Our DB2
...
void S7API ReadEventCallBack(void *usrPtr, PSrvEvent PEvent, int Size)
{
	...
	if (PEvent->EvtParam1==S7AreaDB)
	{
		...
		{
		case 1 : memset(&DB38, ++cnt, sizeof(DB21));break;
		case 2 : memset(&DB102, ++cnt, sizeof(DB103));break;
		case 3 : memset(&DB104, ++cnt, sizeof(DB3));break;
		}
	}
};
...
*/
    ...
    Server->RegisterArea(srvAreaDB, 38, &DB38, sizeof(DB38));
    Server->RegisterArea(srvAreaDB, 102, &DB102, sizeof(DB102));
    Server->RegisterArea(srvAreaDB, 104, &DB104, sizeof(DB104));
